...
export function Communities() {
  return (
    <section id="communities" className="py-40">
      <div className="mx-auto max-w-[1280px] px-8">
        ...
        <RevealOnScroll className="grid grid-cols-1 gap-px overflow-hidden rounded-[20px] border border-line bg-line sm:grid-cols-2 lg:grid-cols-4">
          {COMMUNITIES.map((c) => (
            <TiltCard key={c.slug} maxTilt={4} className="group relative min-h-[200px] bg-bg p-[26px] transition-colors duration-300 hover:bg-bg-1">
              <div
              ...
              />
              <h3 className="relative z-[1] text-[19px] font-medium">{c.name}</h3>
