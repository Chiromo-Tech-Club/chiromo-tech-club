...
import { CalendarPlus, MapPin, Pencil, Trash2, ExternalLink } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-6">
      <p className="text-xs text-muted">
        Create CTC events like Luma — members register on the public event page and see the full explanation.
      </p>
      <EventForm />
